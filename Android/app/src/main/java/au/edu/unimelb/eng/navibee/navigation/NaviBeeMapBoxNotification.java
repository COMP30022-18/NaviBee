...
public class NaviBeeMapBoxNotification implements NavigationNotification {
        ...
        private NavigationView mapboxNavigationView;
        ...
        private BroadcastReceiver endNavigationBtnReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(final Context context, final Intent intent) {
                NaviBeeMapBoxNotification.this.onEndNavigationBtnClick();
            }
        };

        NaviBeeMapBoxNotification(Context context, NavigationView mapboxNavigationView) {
            initialize(context, mapboxNavigationView);
        }
        ...
        private void initialize(Context context, NavigationView mapboxNavigationView) {
            this.mapboxNavigationView = mapboxNavigationView;
            etaFormat = context.getString(com.mapbox.services.android.navigation.R.string.eta_format);
            initializeDistanceFormatter(context);
        ...
        private void createNotificationChannel(Context context) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                NotificationChannel notificationChannel = new NotificationChannel(
                        NAVIGATION_NOTIFICATION_CHANNEL, context.getString(com.mapbox.services.android.navigation.R.string.channel_name),
        ...
        private void buildNotification(Context context) {
            collapsedNotificationRemoteViews = new RemoteViews(context.getPackageName(),
                    com.mapbox.services.android.navigation.R.layout.collapsed_navigation_notification_layout);
            expandedNotificationRemoteViews = new RemoteViews(context.getPackageName(),
                    com.mapbox.services.android.navigation.R.layout.expanded_navigation_notification_layout);
            ...
            expandedNotificationRemoteViews.setOnClickPendingIntent(com.mapbox.services.android.navigation.R.id.endNavigationBtn, pendingCloseIntent);
            ...
            notificationBuilder = new NotificationCompat.Builder(context, NAVIGATION_NOTIFICATION_CHANNEL)
                    ...
                    .setSmallIcon(com.mapbox.services.android.navigation.R.drawable.ic_navigation)
        ...
        private void updateInstructionText(LegStep step) {
            if (hasInstructions(step) && (instructionText == null || newInstructionText(step))) {
                ...
                collapsedNotificationRemoteViews.setTextViewText(com.mapbox.services.android.navigation.R.id.notificationInstructionText, instructionText);
                expandedNotificationRemoteViews.setTextViewText(com.mapbox.services.android.navigation.R.id.notificationInstructionText, instructionText);
            }
        }
        ...
        private void updateDistanceText(RouteProgress routeProgress) {
            if (currentDistanceText == null || newDistanceText(routeProgress)) {
                ...
                collapsedNotificationRemoteViews.setTextViewText(com.mapbox.services.android.navigation.R.id.notificationDistanceText, currentDistanceText);
                expandedNotificationRemoteViews.setTextViewText(com.mapbox.services.android.navigation.R.id.notificationDistanceText, currentDistanceText);
            }
        }
        ...
        private void updateArrivalTime(RouteProgress routeProgress) {
            ...
            int timeFormatType = NavigationTimeFormat.NONE_SPECIFIED;
            ...
            collapsedNotificationRemoteViews.setTextViewText(com.mapbox.services.android.navigation.R.id.notificationArrivalText, formattedArrivalTime);
            expandedNotificationRemoteViews.setTextViewText(com.mapbox.services.android.navigation.R.id.notificationArrivalText, formattedArrivalTime);
        }
        ...
        private void updateManeuverImage(LegStep step) {
            if (newManeuverId(step)) {
                ...
                collapsedNotificationRemoteViews.setImageViewResource(com.mapbox.services.android.navigation.R.id.maneuverImage, maneuverResource);
                expandedNotificationRemoteViews.setImageViewResource(com.mapbox.services.android.navigation.R.id.maneuverImage, maneuverResource);
            }
        }
        ...
        private void onEndNavigationBtnClick() {
            if (mapboxNavigationView.retrieveMapboxNavigation() != null) {
                mapboxNavigationView.retrieveMapboxNavigation().stopNavigation();
            }
        }
